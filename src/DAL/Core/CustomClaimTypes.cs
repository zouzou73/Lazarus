...
namespace DAL.Core
{
    ...
    {
        ///<summary>A claim that specifies the patient id of an entity</summary>
        public const string PatientIdentifier = "patientid";

        ///<summary>A claim that specifies the healthcare provider id of an entity</summary>
        public const string ProviderIdentifier = "hcproviderid";
