...
namespace DAL.Core
{
    public class FacebookAccountManager : IAccountManager
    {
        ...
        public FacebookAccountManager(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
        ...
        {
            bool canDelete = !await _context.Providers.Where(p => p.City == userId).AnyAsync();
