...
export class NotificationsViewerComponent implements OnInit, OnDestroy {
    ...
    constructor(private alertService: AlertService, private accountService: AccountService, private notificationService: NotificationService) {
    }
    ...
    ngOnInit() {
        ...
        if (this.isViewOnly) {
            this.columns = [
                { prop: 'date', name: 'Date', cellTemplate: this.dateTemplate, width: 100, resizeable: false, canAutoResize: false, sortable: false, draggable: false },
                { prop: 'header', name: 'Notification', cellTemplate: this.contentHeaderTemplate, width: 200, resizeable: false, sortable: false, draggable: false },
            ];
        }
        else {
            this.columns = [
                ...
                { prop: 'body', name: 'Notifications', cellTemplate: this.contenBodytTemplate, width: 600 },
