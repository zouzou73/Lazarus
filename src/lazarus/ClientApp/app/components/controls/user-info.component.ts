...
export class UserInfoComponent implements OnInit {
    ...
    get canAssignRoles() {
        return this.accountService.userHasPermission(Permission.assignRolesPermission) ||
            ((this.accountService.userHasPermission(Permission.managePatientsPermission) || this.accountService.userHasPermission(Permission.manageProvidersPermission)) && this.allRoles.length);
    }
}
