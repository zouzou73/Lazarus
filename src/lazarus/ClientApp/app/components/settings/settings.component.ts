...
export class SettingsComponent implements OnInit, OnDestroy {
    ...
    handleLanguageChangedEvent() {
        if (this.activeTab != this.departmentsTab)
            this.isDepartmentsActived = false;
    ...
    showContent(anchor: string) {
        if ((anchor == this.departmentsTab && !this.canViewUsers) || (anchor == this.usersTab && !this.canViewUsers) || (anchor == this.rolesTab && !this.canViewRoles))
            return;
    ...
    onShowTab(event) {
        ...
        switch (this.activeTab) {
            ...
            case this.preferencesTab:
                ...
                break;
            case this.departmentsTab:
                this.isDepartmentsActived = true;
                break;
            case this.usersTab:
