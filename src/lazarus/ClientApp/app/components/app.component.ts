...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    constructor(storageManager: LocalStoreManager, private router: Router, private toastyService: ToastyService, private toastyConfig: ToastyConfig,
        private accountService: AccountService, private alertService: AlertService, private notificationService: NotificationService, private appTitleService: AppTitleService, private authService: AuthService,
        private configurations: ConfigurationService, private translationService: AppTranslationService) {

        storageManager.initialiseStorageSyncListener();

        translationService.addLanguages(["en", "fr", "ar"]);
    ...
    get canViewAppointments() {
        return this.accountService.userHasPermission(Permission.viewAppointmentsPermission) ||
            this.accountService.userHasPermission(Permission.requestAppointmentsPermission) ||
            this.accountService.userHasPermission(Permission.acceptAppointmentsPermission) ||
            this.accountService.userHasPermission(Permission.manageAppointmentsPermission);
    }

    get canViewConsultations() {
        return this.accountService.userHasPermission(Permission.viewConsultationsPermission) ||
            this.accountService.userHasPermission(Permission.acceptAppointmentsPermission);
    }

    get canViewPatients() {
        return this.accountService.userHasPermission(Permission.viewPatientsPermission) ||
            this.accountService.userHasPermission(Permission.managePatientsPermission);
    }

    get canViewProviders() {
        return this.accountService.userHasPermission(Permission.viewProvidersPermission) ||
            this.accountService.userHasPermission(Permission.manageProvidersPermission);
    }

    get canViewHistory() {
        return this.accountService.userHasPermission(Permission.requestAppointmentsPermission);
    }
}