...
export class DBkeys {
    ...
    public static readonly SHOW_DASHBOARD_MEDICAL_HISTORY = "show_dashboard_medical_history";
    public static readonly SHOW_DASHBOARD_NOTIFICATIONS = "show_dashboard_notifications";
    public static readonly SHOW_DASHBOARD_APPOINTMENTS = "show_dashboard_appointments";
}